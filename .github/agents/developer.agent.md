...
### 3) Tests
Write unit or e2e tests for new logic and critical UI behaviors.
...
### Web app testing skill usage
When the task requires browser-based UI testing or end-to-end checks, you MUST follow the guidance in [.github/skills/webapp-testing/SKILL.md](../skills/webapp-testing/SKILL.md).
